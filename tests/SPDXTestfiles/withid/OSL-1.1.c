...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/OSL-1.1.html				
*/



/* SPDX-License-Identifier: OSL-1.1 */
/*
...
1) Grant of
Copyright License. Licensor hereby grants You a world-wide,
...
4)
Exclusions From License Grant. Nothing in this License shall be deemed
...
5) External
Deployment. The term "External Deployment" means the use or
...
License. Nothing else but this License (or another written agreement
...
granted in Sections 1 herein, and any attempt to do so except under
the terms of this License (or another written agreement between
...
Therefore, by exercising any of the rights granted to You in Sections
...
rights granted to You by this License if You file a lawsuit in any
court alleging that any OSI Certified open source software that is
licensed under any license containing this "Mutual Termination for
Patent Action" clause infringes any patent claims that are essential
...
17 U.S.C. å¤ 101 et seq., the equivalent laws of other countries,
