...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/CC-BY-NC-ND-2.0.html				
*/



/* SPDX-License-Identifier: CC-BY-NC-ND-2.0 */
/*
...
Work, You must keep intact all copyright notices for the Work and give
...
Original Author if supplied; the title of the Work if supplied; and to
...
doubt, where the Work is a musical composition:
          ...
          i.
Performancf Royalties Under Blanket Licenses. Licensor reserves the
...
compensation.
     ...
     e. Webcasting Rights and Statutory Royalties. For
the avoidance of doubt, where the Work is a sound recording, Licensor
...
this License. Individuals or entities who have received Collective
