...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/MPL-1.1.html				
*/
...
The Original Code
is <<var;name=code;original=_____;match=.+>>.
...
this file under either the MPL or
the<<var;name=licenseName;original=[____];match=.+>>] License."
*/
