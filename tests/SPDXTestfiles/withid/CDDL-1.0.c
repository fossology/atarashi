...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/CDDL-1.0.html				
*/
...
1.3. “Covered
Software” means (a) the Original Software, or (b) Modifications, or
...
combines Covered Software or portions thereof with code not governed
...
the maximum extent possible, whether at the time of the initial grant
...
addition to, deletion from or modification of the contents of a file
...
computer software code in which modifications are made and (b)
...
are effective on the date Initial Developer first distributes or
otherwise makes the Original Software available to a third party under
...
the Contributor Version; (2) for infringements caused by: (i) third
...
or otherwise make available in Executable form must also be made
...
which You contribute are governed by the terms of this License. You
...
You must include a
notice in each of Your Modifications that identifies You as the
...
on any Covered Software in Source Code form that alters or restricts
...
You may
distribute the Executable form of the Covered Software under the terms
of this License or under the terms of a license of Your choice, which
may contain terms different from this License, provided that You are
in compliance with the terms of this License and that the license for
...
combining Covered Software with other code not governed by the terms
...
and may publish revised and/or new versions of this License from time
...
create a new license for Your Original Software, You may create and
...
or 6.2 above, all end user licenses that have been validly granted by
...
consisting of “commercial computer software” (as that term is
...
Users acquire Covered Software with only those rights set forth
...
within the Original Software, with the losing party responsible for
...
rights under this License and You agree to work with Initial Developer
