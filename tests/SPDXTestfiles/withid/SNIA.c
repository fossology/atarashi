...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/SNIA.html				
*/



/* SPDX-License-Identifier: SNIA */
/*
...
1.3 "Contributor Version" means the
...
1.6 "Executable" means Covered Code in any form
other than Source Code.  

1.7 "Initial Developer" means the
...
1.12 "Original Code" means Source Code of
...
1.13 "Patent Claims" means any patent claim(s), now
...
1.15 "You" (or "Your") means an individual or a
legal entity exercising rights under, and complying with all of the
terms of, this License or a future version of this License issued
under Section 6.1. For legal entities, "You" includes any entity which
...
infringed by the making, using or selling of Original Code, to make,
have made, use, practice, sell, and offer for sale, and/or otherwise
dispose of the Original Code (or portions thereof). 
     (c) the
licenses granted in this Section 2.1(a) and (b) are effective on the
...
the date it initially became available, or at least six (6) months
...
thereafter. 
     (b) Contributor API's. If Contributor's
Modifications include an application programming interface and
Contributor has actual knowledge of patent licenses which are
...
3.5
Required Notices. You must duplicate the notice in Exhibit A in each
...
a user would be most likely to look for such a notice. If You created
one or more Modification(s) You may add your name as a Contributor to
the notice described in Exhibit A. You must also duplicate this
...
claims relating to the Covered Code) incurred by the Initial Developer
...
Initial Developer and every Contributor for any liability (excluding
any liability arising from intellectual property claims relating to
the Covered Code) incurred by the Initial Developer or such
Contributor as a result of any such terms You offer.  

3.7 Larger
Works. You may create a Larger Work by combining Covered Code with
...
Association (the "SNIA") may publish revised and/or new versions of
...
of any subsequent version of the License published by the SNIA. No one
other than the SNIA has the right to modify the terms applicable to
Covered Code created under this License.  

6.3 Derivative Works. If
You create or use a modified version of this License (which you may
only do in order to apply it to code which is not already Covered Code
governed by this License), You must (a) rename Your license so that
the phrases "Storage Networking Industry Association," "SNIA," or any
...
differ from the SNIA Public License. (Filling in the name of the
...
7. DISCLAIMER OF WARRANTY. COVERED
...
fail to cure such breach within a reasonable time after becoming aware
...
to as "Participant") alleging that: o (a) such Participant's
...
11. MISCELLANEOUS This License represents the
...
12. RESPONSIBILITY FOR CLAIMS. As between
Initial Developer and the Contributors, each party is responsible for
...
on an equitable basis. Nothing herein is intended or shall be deemed
...
Your choice of this License or the alternative licenses, if any,
...
use, or distribute the Covered Code for any purpose.

EXHIBIT A The
SNIA Public License.

The contents of this file are subject to the
SNIA Public License Version 1.0 (the "License"); you may not use this
...
Original Code is [COMPLETE THIS] .

Contributor(s):
______________________________________.

Read more about this license
at http://www.snia.org/smi/developers/open_source/
*/
