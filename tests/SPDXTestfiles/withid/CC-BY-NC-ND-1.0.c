...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/CC-BY-NC-ND-1.0.html				
*/
...
Work or any Collective Works, You must keep intact all copyright
...
pseudonym if applicable) of the Original Author if supplied; the title
of the Work if supplied. Such credit may be implemented in any
...
Warranties and Disclaimer
     ...
     a. By offering the Work for public
release under this License, Licensor represents and warrants that, to
