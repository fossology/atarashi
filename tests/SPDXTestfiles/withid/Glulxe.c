...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/Glulxe.html				
*/



/* SPDX-License-Identifier: Glulxe */
/*
The source code in this package is copyright 1999-2010 by Andrew
Plotkin.

You may copy and distribute it freely, by any means and
