...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/CC-BY-ND-3.0.html				
*/
...
otherwise you have no rights to make Adaptations. Subject to Section
...
as required by Section 4(b), as requested.
     ...
     b. If You Distribute,
or Publicly Perform the Work or Collections, You must, unless a
...
credit for all contributing authors of the Collection appears, then as
...
as part of any Collections, You must not distort, mutilate, modify or
