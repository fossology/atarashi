...
/*
Copyright (c) 2000-<<var;name=year;original=(insert then current
year);match=.+>>. OCLC Online Computer Library Center, Inc. and other
contributors. All rights reserved. 

The contents of this file, as
updated from time to time by the OCLC Office of Research, are subject
to OCLC Research Public License Version 2.0 (the "License"); you may
not use this file except in compliance with the License. You may
obtain a current copy of the License at
...
please see http://www.oclc.org/research/. 

The Original Code is
<<var;name=code;original=_____;match=.+>>.. The Initial Developer of
the Original Code is
<<var;name=InitialDeveloper;original=_____;match=.+>>. Portions
