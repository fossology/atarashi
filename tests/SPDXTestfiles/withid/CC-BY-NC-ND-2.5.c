...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/CC-BY-NC-ND-2.5.html				
*/
...
formats, but otherwise you have no rights to make Derivative Works.
...
clause 4(c), as requested.
     ...
     b. You may not exercise any of the
...
of copyrighted works.
     ...
     c. If you distribute, publicly display,
publicly perform, or publicly digitally perform the Work, You must
...
composition:
          ...
          i. Performance Royalties Under Blanket
Licenses. Licensor reserves the exclusive right to collect, whether
