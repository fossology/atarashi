...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/Cube.html				
*/
...
Copyright (C)
2001-2003 Wouter van Oortmerssen.
...
misrepresented as being the original software. 
     ...
     3. This notice
may not be removed or altered from any source
distribution.

additional clause specific to Cube:

     4. Source
versions may not be "relicensed" under a different license without my
