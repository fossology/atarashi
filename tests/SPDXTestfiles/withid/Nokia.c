...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/Nokia.html				
*/
...
which is directly or indirectly controlling such party;
     ...
     b) which
is under the same direct or indirect ownership or control as such
party; or

     c) which is directly or indirectly owned or controlled
by such party.

     For these purposes, an entity shall be treated as
being controlled by another if that other entity has fifty percent
...
otherwise making the Covered Software available to a third
party.
...
"Contributor Version"
shall mean in case of any Contributor the combination of the Original
Software, prior Modifications used by a Contributor, and the
Modifications made by that particular Contributor and in case of Nokia
...
"Electronic
Distribution Mechanism" shall mean a mechanism generally accepted in
the software development community for the electronic transfer of
data.

"Executable" shall mean Covered Software in any form other than
Source Code.

"Nokia" shall mean Nokia Corporation and its
Affiliates.
...
"Licensable" shall
mean having the right to grant, to the maximum extent possible,
...
Original Software or any previous Modifications. When Covered Software
...
required by Exhibit A as Original Software, and which, at the time of
its release under this License is not already Covered Software
governed by this License.

"Patent Claims" shall mean any patent
...
the Covered Software for making modifications to it, including all
...
"You" (or "Your") shall
mean an individual or a legal entity exercising rights under, and
...
includes Affiliates of such entity.

2. SOURCE CODE LICENSE.

     2.1
Nokia Grant.
     Subject to the terms of this License, Nokia hereby
grants You a world-wide, royalty-free, non-exclusive license, subject
to third party intellectual property claims:

     a) under copyrights
Licensable by Nokia to use, reproduce, modify, display, perform,
...
or selling of Original Software, to make, have made, use, practice,
sell, and offer for sale, and/or otherwise dispose of the Original
Software (or portions thereof).

     c) The licenses granted in this
Section 2.1(a) and (b) are effective on the date Nokia first
...
from the Original Software; or 3) for infringements caused by: i) the
...
as part of a Larger Work; and
     ...
     b) under Patent Claims necessarily
...
Contributor Version (or portions of such combination).
     ...
     c) The
licenses granted in Sections 2.2(a) and 2.2(b) are effective on the
...
Software may be distributed only under the terms of this License or a
...
Software to which You contribute to contain a file documenting the
changes You made to create that Covered Software and the date of any
change. You must include a prominent statement that the Modification
is derived, directly or indirectly, from Original Software provided by
Nokia and including the name of Nokia in (a) the Source Code, and (b)
...
which You describe the origin or ownership of the Covered Software.
   ...
   3.4 Intellectual Property Matters
          ...
          (a) Third Party
Claims. If Contributor has knowledge that a license under a third
...
an application programming interface and Contributor has knowledge of
...
as a relevant directory) where a user would be likely to look for such
a notice. If You created one or more Modification(s) You may add your
...
Covered Software. You may choose to offer, and to charge a fee for,
warranty, support, indemnity or liability obligations to one or more
recipients of Covered Software. However, You may do so only on Your
own behalf, and not on behalf of Nokia or any Contributor. You must
make it absolutely clear that any such warranty, support, indemnity or
liability obligation is offered by You alone, and You hereby agree to
indemnify Nokia and every Contributor for any liability incurred by
Nokia or such Contributor as a result of warranty, support, indemnity
or liability terms You offer.

     3.6 Distribution of Executable
Versions.
     You may distribute Covered Software in Executable form
only if the requirements of Section 3.1-3.5 have been met for that
Covered Software, and if You include a notice stating that the Source
Code version of the Covered Software is available under the terms of
...
alone, not by Nokia or any Contributor. You hereby agree to indemnify
Nokia and every Contributor for any liability incurred by Nokia or
such Contributor as a result of any such terms You offer.

     3.7
Larger Works.
     You may create a Larger Work by combining Covered
Software with other software not governed by the terms of this License
...
terms of this License with respect to some or all of the Covered
...
LICENSE.
This License applies to code to which Nokia has attached the
notice in Exhibit A and to related Covered Software.

6. VERSIONS OF
THE LICENSE. 

     6.1 New Versions.
     Nokia may publish revised
...
Covered Software under the terms of any subsequent version of the
License published by Nokia. No one other than Nokia has the right to
modify the terms applicable to Covered Software created under this
License.
...
ANY COVERED SOFTWARE PROVE DEFECTIVE IN ANY RESPECT, YOU (NOT NOKIA,
ITS LICENSORS OR AFFILIATES OR ANY OTHER CONTRIBUTOR) ASSUME THE COST
...
becoming aware of the breach. All sublicenses to the Covered Software
...
(Nokia or Contributor against whom You file such action is referred to
...
Modifications made by that Participant.
     ...
     8.3 If You assert a
patent infringement claim against Participant alleging that such
...
amount or value of any payment or license.
     ...
     8.4 In the event of
termination under Sections 8.1 or 8.2 above, all end user license
...
TORT (INCLUDING NEGLIGENCE), CONTRACT, OR OTHERWISE, SHALL YOU, NOKIA,
...
EXCLUSION OR LIMITATION OF INCIDENTAL OR CONSEQUENTIAL DAMAGES, BUT
MAY ALLOW LIABILITY TO BE LIMITED; IN SUCH CASES, A PARTY's, ITS
EMPLOYEES, LICENSORS OR AFFILIATES' LIABILITY SHALL BE LIMITED TO U.S.
$50. Nothing contained in this License shall prejudice the statutory
...
This License is governed by the
laws of Finland excluding its conflict-of-law provisions. All disputes
...
As between
Nokia and the Contributors, each party is responsible for claims and
damages arising, directly or indirectly, out of its utilization of
rights under this License and You agree to work with Nokia and
...
subject to the NOKOS License Version 1.0 (the "License"); you may not
