...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/MS-PL.html				
*/
...
copyright law. A "contribution" is the original software, or any
...
2.  Grant of Rights
     (A) Copyright Grant- Subject
to the terms of this license, including the license conditions and
limitations in section 3, each contributor grants you a non-exclusive,
worldwide, royalty-free copyright license to reproduce its
contribution, prepare derivative works of its contribution, and
...
contributor over patents that you claim are infringed by the software,
