...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/StandardML-NJ.html				
*/



/* SPDX-License-Identifier: StandardML-NJ */
/*
STANDARD ML OF NEW JERSEY COPYRIGHT NOTICE, LICENSE AND
DISCLAIMER.

Copyright (c) 1989-1998 by Lucent
Technologies
...
the name of Lucent Technologies, Bell Labs or any Lucent entity not be
