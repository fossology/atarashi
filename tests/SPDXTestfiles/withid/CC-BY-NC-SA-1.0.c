...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/CC-BY-NC-SA-1.0.html				
*/
...
PROVIDED HERE, YOU ACCEPT AND AGREE TO BE BOUND BY THE TERMS OF THIS
...
perform a Derivative Work only under the terms of this License, and
You must include a copy of, or the Uniform Resource Identifier for,
this License with every copy or phonorecord of each Derivative Work
...
License.
     ...
     c. You may not exercise any of the rights granted to
...
if supplied; in the case of a Derivative Work, a credit identifying
...
license granted here is perpetual (for the duration of the applicable
...
8. Miscellaneous
     ...
     a. Each
time You distribute or publicly digitally perform the Work or a
