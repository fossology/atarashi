...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/GL2PS.html				
*/



/* SPDX-License-Identifier: GL2PS */
/*
GL2PS LICENSE Version 2, November 2003

Copyright (C) 2003, Christophe
Geuzaine
...
modified versions of this software is granted, provided that:

1) the
modifications are licensed under the same terms as this software;

2)
you make available the source code of any modifications that you
