...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/CC-BY-SA-2.0.html				
*/
...
this License.
     ...
     b. "Derivative Work" means a work based upon the
...
2.
Fair Use Rights. Nothing in this license is intended to reduce, limit,
...
Licensor waives the exclusive right to collect, whether individually
or via a music rights society or designated agent (e.g. Harry Fox
...
equivalent in other jurisdictions).
     ...
     f. Webcasting Rights and
Statutory Royalties. For the avoidance of doubt, where the Work is a
sound recording, Licensor waives the exclusive right to collect,
...
Licensor or the Original Author, as requested.
     ...
     b. You may
distribute, publicly display, publicly perform, or publicly digitally
perform a Derivative Work only under the terms of this License, a
...
License Elements as this License (e.g. Attribution-ShareAlike 2.0
Japan). You must include a copy of, or the Uniform Resource Identifier
for, this License or other license specified in the previous sentence
with every copy or phonorecord of each Derivative Work You distribute,
publicly display, publicly perform, or publicly digitally perform. You
...
if supplied; the title of the Work if supplied; to the extent
...
the Work; and in the case of a Derivative Work, a credit identifying
the use of the Work in the Derivative Work (e.g., "French translation
of the Work by Original Author," or "Screenplay based on original Work
by Original Author"). Such credit may be implemented in any reasonable
...
BY THE PARTIES IN WRITING, LICENSOR OFFERS THE WORK AS-IS AND MAKES NO
...
this License. Individuals or entities who have received Derivative
Works or Collective Works from You under this License, however, will
