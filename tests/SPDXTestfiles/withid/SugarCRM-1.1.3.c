...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/SugarCRM-1.1.3.html				
*/



/* SPDX-License-Identifier: SugarCRM-1.1.3 */
/*
...
is SugarCRM, Inc.
Portions created by SugarCRM are Copyright (C) 2004
SugarCRM, Inc.;
All Rights Reserved.
Contributor(s): _____.
*/
