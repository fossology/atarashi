...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/CDDL-1.1.html				
*/
...
form of any of the following:
     ...
     A. Any file that results from
an addition to, deletion from or modification of the contents of a
...
contributed or otherwise made available under the terms of this
License.
...
1.12. “Source Code” means (a) the common
form of computer software code in which modifications are made and (b)
...
above, all end user licenses that have been validly granted by You or
...
This License
represents the complete agreement concerning subject matter hereof. If
any provision of this License is held to be unenforceable, such
