...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/CUA-OPL-1.0.html				
*/



/* SPDX-License-Identifier: CUA-OPL-1.0 */
/*
...
<<var;name=developer;original=_____;match=.+>>.
Portions created by 
<<var;name=createdby;original=_____;match=.+>> are Copyright (C) 
<<var;name=copyright;original=_____;match=.+>>. All Rights
Reserved.
...
allow others to use your version of this file under the CUAPL,
...
this file under either the CUAPL or the
