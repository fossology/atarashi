...
Modifications, or as part of a Larger Work; and
          ...
          (b) under
patents now or hereafter owned or controlled by Initial Developer, to
...
owned or controlled by Contributor, to Utilize the Contributor Version
(or portions thereof), but solely to the extent that any such patent
is reasonably necessary to enable You to Utilize the Contributor
Version (or portions thereof), and not to any greater extent that may
...
Covered Code.
     ...
     3.4. Intellectual Property Matters
          ...
          (a)
Third Party Claims.
          If You have knowledge that a party
claims an intellectual property right in particular functionality or
code (or its utilization under this License), you must include a text
...
obtained.
          ...
          (b) Contributor APIs.
          If Your
Modification is an application programming interface and You own or
control patents which are reasonably necessary to implement that API,
...
if the requirements of Section 3.1-3.5 have been met for that Covered
...
collateral in which You descr ibe recipients' rights relating to the
...
6. Versions of the License.
    ...
    6.1. New Versions.
     Floris van den Berg may publish revised
...
No one other than Floris van den Berg
has the right to modify the terms applicable to Covered Code created
under this License.

     6.3. Derivative Works.
     If you create or
use a modified version of this License (which you may only do in order
...
"FreeImage", `FreeImage Public License", "FIPL", or any confusingly
...
terms which differ from the FreeImage Public License. (Filling in the
...
governed by Dutch law provisions (except to the extent applicable law,
if any, provides otherwise), excluding its conflict-of-law provisions.
With respect to disputes in which at least one party is a citizen of,
or an entity chartered or registered to do business in, the The
Netherlands: (a) unless otherwise agreed in writing, all disputes
relating to this License (excepting any dispute relating to
...
(b) any arbitration relating to this Agreement shall be held in
...
another Contributor has failed to comply with Section 3.4, You are
...
work with affected parties to distribute responsibility on an
equitable basis.

EXHIBIT A.

"The contents of this file are subject
to the FreeImage Public License Version 1.0 (the "License"); you may
