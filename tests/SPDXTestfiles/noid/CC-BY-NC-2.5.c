...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/CC-BY-NC-2.5.html				
*/
...
entity who created the Work.
     ...
     d. "Work" means the copyrightable
work of authorship offered under the terms of this License.
...
incorporate the Work into one or more Collective Works, and to
...
perform publicly by means of a digital audio transmission the Work
...
granted hereunder.
     ...
     b. You may not sublicense the Work. You must
...
requested. You may not exercise any of the rights granted to You in
...
(i) the name of Original Author (or pseudonym, if applicable) if
