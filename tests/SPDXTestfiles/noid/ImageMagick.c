...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/ImageMagick.html				
*/
...
It allows you to:
     ...
     * freely
download and use ImageMagick software, in whole or in part, for
...
ImageMagick software in packages or distributions that you create;    
     ...
     * link
code under a different license against a library under this license; 
...
It forbids you to:
     ...
     * redistribute
any piece of ImageMagick-originated software without proper
attribution; 
     * use any marks owned by ImageMagick Studio LLC in
any way that might state or imply that ImageMagick Studio LLC endorses
your distribution; 
     * use any marks owned by ImageMagick Studio
LLC in any way that might state or imply that you created the
ImageMagick software in question. 
...
the ImageMagick software itself, or of any modifications you may have
...
ImageMagick Studio LLC (though such feedback is encouraged). 

A few
other clarifications include:

     * ImageMagick is freely available
without charge; 
     * you may include ImageMagick on a DVD as long
as you comply with the terms of the license; 
     * you can give
modified code away for free or sell it under the terms of the
ImageMagick license or distribute the result under a different
license, but you need to acknowledge the use of the ImageMagick
software; 
     * the license is compatible with the GPL V3. 
     *
when exporting the ImageMagick software, review its export
classification. 

Terms and Conditions for Use, Reproduction, and
Distribution

The legally binding and authoritative terms and
conditions for use, reproduction, and distribution of ImageMagick
follow:
...
file as part of its distribution, then any Derivative Works that You
...
Additional Liability. While redistributing the Work or Derivative
...
To apply
the ImageMagick License to your work, attach the following boilerplate
...
[yyyy] [name of copyright owner]
     ...
     Licensed under the ImageMagick
