...
conditions of this License Agreement, CNRI hereby grants Licensee a
...
distribute, and otherwise use Python 1.6b1 alone or in any derivative
version, provided, however, that CNRIs License Agreement is retained
in Python 1.6b1, alone or in any derivative version prepared by
Licensee.

Alternately, in lieu of CNRIs License Agreement, Licensee
may substitute the following text (omitting the quotes): "Python 1.6,
beta 1, is made available subject to the terms and conditions in CNRIs
License Agreement. This Agreement may be located on the Internet using
...
4. CNRI is making Python 1.6b1
available to Licensee on an "AS IS" basis. CNRI MAKES NO
...
ANY DERIVATIVE THEREOF, EVEN IF ADVISED OF THE POSSIBILITY
THEREOF.
...
law of the State of Virginia, excluding conflict of law provisions.
...
8. By clicking
on the "ACCEPT" button where indicated, or by copying, installing or
