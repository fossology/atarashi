...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/CC-BY-NC-ND-3.0.html				
*/
...
the original and copies of the Work through sale or other transfer of
ownership.
...
License.
     ...
     e. "Original Author" means, in the case of a literary
...
necessary to exercise the rights in other media and formats, but
otherwise you have no rights to make Adaptations. Subject to 8(f), all
...
Publicly Perform the Work or Collections, You must, unless a request
...
be implemented in any reasonable manner; provided, however, that in
the case of a Collection, at a minimum such credit will appear, if a
credit for all contributing authors of Collection appears, then as
...
this License. Individuals or entities who have received Collections
