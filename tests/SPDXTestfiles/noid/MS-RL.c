...
"derivative works," and "distribution" have the same meaning here as
...
2.  Grant of Rights
     (A) Copyright
Grant- Subject to the terms of this license, including the license
...
binary format), you must provide recipients the source code to that
file along with a copy of this license, which license will govern that
file. You may license other files that are entirely your own work and
...
use any contributors' name, logo, or trademarks. 
     ...
     (C) If you
bring a patent claim against any contributor over patents that you
...
software. 
     ...
     (E) If you distribute any portion of the software in
