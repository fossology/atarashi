...
** 										
**
** SPDX License to detect: https://spdx.org/licenses/CC-BY-NC-3.0.html				
*/
...
any of the rights granted to You in Section 3 above in any manner that
...
of copyrighted works.
     ...
     c. If You Distribute, or Publicly Perform
the Work or any Adaptations or Collections, You must, unless a request
