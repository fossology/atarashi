...
#define __PYX_HAVE__DLD
#define __PYX_HAVE_API__DLD
/* Early includes */
#include <string.h>
#include <stdlib.h>
#ifdef _OPENMP
...
#define __Pyx_GetItemInt(o, i, type, is_signed, to_py_func, is_list, wraparound, boundscheck) \
    (__Pyx_fits_Py_ssize_t(i, type, is_signed) ? __Pyx_GetItemInt_Fast(o, (Py_ssize_t)i, is_list, wraparound, boundscheck) : (is_list ? (PyErr_SetString(PyExc_IndexError, "list index out of range"), (PyObject *)NULL) : __Pyx_GetItemInt_Generic(o, to_py_func(i))))
#define __Pyx_GetItemInt_List(o, i, type, is_signed, to_py_func, is_list, wraparound, boundscheck) \
    (__Pyx_fits_Py_ssize_t(i, type, is_signed) ? __Pyx_GetItemInt_List_Fast(o, (Py_ssize_t)i, wraparound, boundscheck) : (PyErr_SetString(PyExc_IndexError, "list index out of range"), (PyObject *)NULL))
static CYTHON_INLINE PyObject *__Pyx_GetItemInt_List_Fast(PyObject *o, Py_ssize_t i,
                                                          int wraparound, int boundscheck);
#define __Pyx_GetItemInt_Tuple(o, i, type, is_signed, to_py_func, is_list, wraparound, boundscheck) \
    (__Pyx_fits_Py_ssize_t(i, type, is_signed) ? __Pyx_GetItemInt_Tuple_Fast(o, (Py_ssize_t)i, wraparound, boundscheck) : (PyErr_SetString(PyExc_IndexError, "tuple index out of range"), (PyObject *)NULL))
...
/* Module declarations from 'DLD' */
static Py_ssize_t __pyx_v_3DLD_TWO;
static Py_ssize_t __pyx_v_3DLD_ONE;
static Py_ssize_t __pyx_v_3DLD_ROW;
static unsigned long __pyx_f_3DLD_damerau_levenshtein_distance(PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
#define __Pyx_MODULE_NAME "DLD"
extern int __pyx_module_is_main_DLD;
int __pyx_module_is_main_DLD = 0;

/* Implementation of 'DLD' */
...
static const char __pyx_k_damerau_levenshtein_distance_lin[] = "damerau_levenshtein_distance (line 29)";
...
static PyObject *__pyx_pf_3DLD_damerau_levenshtein_distance(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_seq1, PyObject *__pyx_v_seq2); /* proto */
/* Late includes */
...
static PyObject *__pyx_pw_3DLD_1damerau_levenshtein_distance(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static unsigned long __pyx_f_3DLD_damerau_levenshtein_distance(PyObject *__pyx_v_seq1, PyObject *__pyx_v_seq2, CYTHON_UNUSED int __pyx_skip_dispatch)
{
    Py_ssize_t __pyx_v_first_difference;
    ...
    while (1)
    {
        __pyx_t_2 = PyObject_Length(__pyx_v_seq1);
        if (unlikely(__pyx_t_2 == ((Py_ssize_t)-1)))
            __PYX_ERR(0, 50, __pyx_L1_error)
        __pyx_t_3 = ((__pyx_v_first_difference < __pyx_t_2) != 0);
        if (__pyx_t_3)
        {
        }
        else
         ...
         *         first_difference += 1
         */
        __pyx_t_2 = PyObject_Length(__pyx_v_seq2);
        if (unlikely(__pyx_t_2 == ((Py_ssize_t)-1)))
         ...
         *
         */
        __pyx_t_4 = __Pyx_GetItemInt(__pyx_v_seq1, __pyx_v_first_difference, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1);
        if (unlikely(!__pyx_t_4))
            __PYX_ERR(0, 52, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_5 = __Pyx_GetItemInt(__pyx_v_seq2, __pyx_v_first_difference, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1);
        if (unlikely(!__pyx_t_5))
            __PYX_ERR(0, 52, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_6 = PyObject_RichCompare(__pyx_t_4, __pyx_t_5, Py_EQ);
    ...
    __pyx_L5_bool_binop_done:;
         ...
         */
        __pyx_v_first_difference = (__pyx_v_first_difference + 1);
    }
     ...
     *
     */
    __pyx_t_6 = __Pyx_PyObject_GetSlice(__pyx_v_seq1, __pyx_v_first_difference, 0, NULL, NULL, NULL, 1, 0, 1);
    if (unlikely(!__pyx_t_6))
     ...
     *     if seq1 is None:
     */
    __pyx_t_6 = __Pyx_PyObject_GetSlice(__pyx_v_seq2, __pyx_v_first_difference, 0, NULL, NULL, NULL, 1, 0, 1);
    if (unlikely(!__pyx_t_6))
    ...
    __pyx_t_7 = PyObject_Length(__pyx_v_seq1);
     ...
     *
     */
    __pyx_t_7 = PyObject_Length(__pyx_v_seq2);
    if (unlikely(__pyx_t_7 == ((Py_ssize_t)-1)))
    ...
    /*try:*/ {
        ...
        for (__pyx_t_10 = 1; __pyx_t_10 < __pyx_t_2; __pyx_t_10 += 1)
        {
             ...
             */
            (__pyx_v_storage[((__pyx_v_3DLD_ROW * __pyx_v_offset) + (__pyx_v_i - 1))]) = __pyx_v_i;
        }
        ...
        for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_2; __pyx_t_10 += 1)
        {
            ...
            for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13 += 1)
            {
                 ...
                 */
                (__pyx_v_storage[((__pyx_v_3DLD_TWO * __pyx_v_offset) + __pyx_v_j)]) = (__pyx_v_storage[((__pyx_v_3DLD_ONE * __pyx_v_offset) + __pyx_v_j)]);
                 ...
                 */
                (__pyx_v_storage[((__pyx_v_3DLD_ONE * __pyx_v_offset) + __pyx_v_j)]) = (__pyx_v_storage[((__pyx_v_3DLD_ROW * __pyx_v_offset) + __pyx_v_j)]);
            }
             ...
             */
            __pyx_t_11 = PyObject_Length(__pyx_v_seq2);
            ...
            for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13 += 1)
            {
                 ...
                 *
                 */
                (__pyx_v_storage[((__pyx_v_3DLD_ROW * __pyx_v_offset) + __pyx_v_j)]) = 0;
            }
            ...
            __pyx_t_11 = PyObject_Length(__pyx_v_seq2);
            if (unlikely(__pyx_t_11 == ((Py_ssize_t)-1)))
                __PYX_ERR(0, 84, __pyx_L13_error)
            (__pyx_v_storage[((__pyx_v_3DLD_ROW * __pyx_v_offset) + __pyx_t_11)]) = (__pyx_v_i + 1);
            ...
            for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13 += 1)
            {
                 ...
                 */
                __pyx_v_delete_cost = ((__pyx_v_storage[((__pyx_v_3DLD_ONE * __pyx_v_offset) + __pyx_v_j)]) + 1);
                ...
                {
                    __pyx_t_15 = PyObject_Length(__pyx_v_seq2);
                    if (unlikely(__pyx_t_15 == ((Py_ssize_t)-1)))
                        __PYX_ERR(0, 88, __pyx_L13_error)
                    __pyx_t_14 = __pyx_t_15;
                }
                __pyx_v_add_cost = ((__pyx_v_storage[((__pyx_v_3DLD_ROW * __pyx_v_offset) + __pyx_t_14)]) + 1);
                ...
                else
                {
                    __pyx_t_15 = PyObject_Length(__pyx_v_seq2);
                    if (unlikely(__pyx_t_15 == ((Py_ssize_t)-1)))
                        __PYX_ERR(0, 89, __pyx_L13_error)
                    __pyx_t_14 = __pyx_t_15;
                }
                __pyx_t_6 = __Pyx_PyInt_From_unsigned_long((__pyx_v_storage[((__pyx_v_3DLD_ONE * __pyx_v_offset) + __pyx_t_14)]));
                if (unlikely(!__pyx_t_6))
                    __PYX_ERR(0, 89, __pyx_L13_error)
                __Pyx_GOTREF(__pyx_t_6);
                __pyx_t_5 = __Pyx_GetItemInt(__pyx_v_seq1, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1);
                if (unlikely(!__pyx_t_5))
                    __PYX_ERR(0, 89, __pyx_L13_error)
                __Pyx_GOTREF(__pyx_t_5);
                __pyx_t_4 = __Pyx_GetItemInt(__pyx_v_seq2, __pyx_v_j, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1);
                if (unlikely(!__pyx_t_4))
                    __PYX_ERR(0, 89, __pyx_L13_error)
                __Pyx_GOTREF(__pyx_t_4);
                __pyx_t_16 = PyObject_RichCompare(__pyx_t_5, __pyx_t_4, Py_NE);
                ...
                __Pyx_DECREF(__pyx_t_4);
                __pyx_t_4 = 0;
                __pyx_t_4 = PyNumber_Add(__pyx_t_6, __pyx_t_16);
                if (unlikely(!__pyx_t_4))
                    __PYX_ERR(0, 89, __pyx_L13_error)
                __Pyx_GOTREF(__pyx_t_4);
                __Pyx_DECREF(__pyx_t_6);
                ...
                __pyx_t_16 = 0;
                __pyx_t_17 = __Pyx_PyInt_As_unsigned_long(__pyx_t_4);
                if (unlikely((__pyx_t_17 == (unsigned long)-1) && PyErr_Occurred()))
                    __PYX_ERR(0, 89, __pyx_L13_error)
                __Pyx_DECREF(__pyx_t_4);
                __pyx_t_4 = 0;
                ...
                (__pyx_v_storage[((__pyx_v_3DLD_ROW * __pyx_v_offset) + __pyx_v_j)]) = __pyx_t_20;
                ...
                __pyx_t_4 = __Pyx_GetItemInt(__pyx_v_seq1, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1);
                if (unlikely(!__pyx_t_4))
                    __PYX_ERR(0, 92, __pyx_L13_error)
                __Pyx_GOTREF(__pyx_t_4);
                __pyx_t_14 = (__pyx_v_j - 1);
                __pyx_t_16 = __Pyx_GetItemInt(__pyx_v_seq2, __pyx_t_14, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1);
                if (unlikely(!__pyx_t_16))
                    __PYX_ERR(0, 92, __pyx_L13_error)
                __Pyx_GOTREF(__pyx_t_16);
                __pyx_t_6 = PyObject_RichCompare(__pyx_t_4, __pyx_t_16, Py_EQ);
                __Pyx_XGOTREF(__pyx_t_6);
                if (unlikely(!__pyx_t_6))
                    __PYX_ERR(0, 92, __pyx_L13_error)
                __Pyx_DECREF(__pyx_t_4);
                ...
                __pyx_t_6 = __Pyx_GetItemInt(__pyx_v_seq1, __pyx_t_14, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1);
                if (unlikely(!__pyx_t_6))
                    __PYX_ERR(0, 92, __pyx_L13_error)
                __Pyx_GOTREF(__pyx_t_6);
                __pyx_t_16 = __Pyx_GetItemInt(__pyx_v_seq2, __pyx_v_j, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1);
                if (unlikely(!__pyx_t_16))
                    __PYX_ERR(0, 92, __pyx_L13_error)
                __Pyx_GOTREF(__pyx_t_16);
                __pyx_t_4 = PyObject_RichCompare(__pyx_t_6, __pyx_t_16, Py_EQ);
                ...
                __Pyx_DECREF(__pyx_t_16);
                __pyx_t_16 = 0;
                __pyx_t_3 = __Pyx_PyObject_IsTrue(__pyx_t_4);
                if (unlikely(__pyx_t_3 < 0))
                    __PYX_ERR(0, 92, __pyx_L13_error)
                __Pyx_DECREF(__pyx_t_4);
                __pyx_t_4 = 0;
                ...
                if (unlikely(!__pyx_t_16))
                    __PYX_ERR(0, 92, __pyx_L13_error)
                __Pyx_GOTREF(__pyx_t_16);
                __pyx_t_6 = PyObject_RichCompare(__pyx_t_4, __pyx_t_16, Py_NE);
                __Pyx_XGOTREF(__pyx_t_6);
                if (unlikely(!__pyx_t_6))
                    __PYX_ERR(0, 92, __pyx_L13_error)
                __Pyx_DECREF(__pyx_t_4);
            ...
            __pyx_L26_bool_binop_done:;
                if (__pyx_t_1)
                {
                    ...
                    if (((__pyx_v_j > 1) != 0))
                    {
                        __pyx_t_14 = (((__pyx_v_3DLD_TWO * __pyx_v_offset) + __pyx_v_j) - 2);
                    }
                    else
                    {
                        __pyx_t_15 = PyObject_Length(__pyx_v_seq2);
                     ...
                     *
                     */
                    __pyx_t_17 = (__pyx_v_storage[((__pyx_v_3DLD_ROW * __pyx_v_offset) + __pyx_v_j)]);
                     ...
                     *
                     */
                    (__pyx_v_storage[((__pyx_v_3DLD_ROW * __pyx_v_offset) + __pyx_v_j)]) = __pyx_t_18;
        ...
        __pyx_r = (__pyx_v_storage[((__pyx_v_3DLD_ROW * __pyx_v_offset) + (__pyx_t_7 - 1))]);
    ...
    __pyx_L13_error:;
        /*exception exit:*/ {
            ...
            if ((PY_MAJOR_VERSION < 3) || unlikely(__Pyx_GetException(&__pyx_t_9, &__pyx_t_8, &__pyx_t_24) < 0))
                __Pyx_ErrFetch(&__pyx_t_9, &__pyx_t_8, &__pyx_t_24);
            ...
            __pyx_t_21 = __pyx_lineno;
            __pyx_t_22 = __pyx_clineno;
            __pyx_t_23 = __pyx_filename;
            {
            ...
            __pyx_t_26 = 0;
            __pyx_t_27 = 0;
            __pyx_lineno = __pyx_t_21;
            __pyx_clineno = __pyx_t_22;
            __pyx_filename = __pyx_t_23;
            goto __pyx_L1_error;
        }
    __pyx_L12_return:
    {
...
__pyx_L1_error:;
    ...
    __Pyx_XDECREF(__pyx_t_6);
    __Pyx_XDECREF(__pyx_t_16);
    __Pyx_WriteUnraisable("DLD.damerau_levenshtein_distance", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
    __pyx_r = 0;
__pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_3DLD_1damerau_levenshtein_distance(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_3DLD_damerau_levenshtein_distance[] = "\n        Return the edit distance. This implementation is based on Michael Homer's implementation\n        (https://web.archive.org/web/20150909134357/http://mwh.geek.nz:80/2009/04/26/python-damerau-levenshtein-distance/)\n        and runs in O(N*M) time using O(M) space. This code implements the \"optimal string alignment distance\"\n        algorithm, as described in Wikipedia here:\n        https://en.wikipedia.org/wiki/Damerau%E2%80%93Levenshtein_distance#Optimal_string_alignment_distance\n        Note that `seq1` and `seq2` can be any sequence type. This not only includes `str` but also includes `list`,\n        `tuple`, `range`, and more.\n        Examples:\n        >>> damerau_levenshtein_distance('smtih', 'smith')\n        1\n        >>> damerau_levenshtein_distance('saturday', 'sunday')\n        3\n        >>> damerau_levenshtein_distance('orange', 'pumpkin')\n        7\n        >>> damerau_levenshtein_distance([1, 2, 3, 4, 5, 6], [7, 8, 9, 7, 10, 11, 4])\n        7\n    ";
static PyObject *__pyx_pw_3DLD_1damerau_levenshtein_distance(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds)
{
        ...
        __Pyx_RefNannySetupContext("damerau_levenshtein_distance (wrapper)", 0);
    {
        ...
        if (unlikely(__pyx_kwds))
        {
            ...
            {
            case 0:
                if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_seq1)) != 0))
                    kw_args--;
                else
                    goto __pyx_L5_argtuple_error;
                CYTHON_FALLTHROUGH;
            case 1:
                if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_seq2)) != 0))
                    kw_args--;
                else
                {
                    __Pyx_RaiseArgtupleInvalid("damerau_levenshtein_distance", 1, 2, 2, 1);
                    __PYX_ERR(0, 29, __pyx_L3_error)
                }
            }
            if (unlikely(kw_args > 0))
            {
                if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "damerau_levenshtein_distance") < 0))
                    __PYX_ERR(0, 29, __pyx_L3_error)
            }
        }
...
__pyx_L5_argtuple_error:;
    __Pyx_RaiseArgtupleInvalid("damerau_levenshtein_distance", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args));
    __PYX_ERR(0, 29, __pyx_L3_error)
__pyx_L3_error:;
    __Pyx_AddTraceback("DLD.damerau_levenshtein_distance", __pyx_clineno, __pyx_lineno, __pyx_filename);
    __Pyx_RefNannyFinishContext();
    return NULL;
__pyx_L4_argument_unpacking_done:;
    __pyx_r = __pyx_pf_3DLD_damerau_levenshtein_distance(__pyx_self, __pyx_v_seq1, __pyx_v_seq2);
...
static PyObject *__pyx_pf_3DLD_damerau_levenshtein_distance(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_seq1, PyObject *__pyx_v_seq2)
{
    ...
    __pyx_t_1 = __Pyx_PyInt_From_unsigned_long(__pyx_f_3DLD_damerau_levenshtein_distance(__pyx_v_seq1, __pyx_v_seq2, 0));
    if (unlikely(!__pyx_t_1))
...
static PyMethodDef __pyx_methods[] = {
    {"damerau_levenshtein_distance", (PyCFunction)(void *)(PyCFunctionWithKeywords)__pyx_pw_3DLD_1damerau_levenshtein_distance, METH_VARARGS | METH_KEYWORDS, __pyx_doc_3DLD_damerau_levenshtein_distance},
    {0, 0, 0, 0}};

#if PY_MAJOR_VERSION >= 3
#if CYTHON_PEP489_MULTI_PHASE_INIT
static PyObject *__pyx_pymod_create(PyObject *spec, PyModuleDef *def); /*proto*/
static int __pyx_pymod_exec_DLD(PyObject *module);                     /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
    {Py_mod_create, (void *)__pyx_pymod_create},
    {Py_mod_exec, (void *)__pyx_pymod_exec_DLD},
    {0, NULL}};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "DLD",
    __pyx_k_Copyright_2022_Sushant_Kumar_su, /* m_doc */
#if CYTHON_PEP489_MULTI_PHASE_INIT
    0,                                       /* m_size */
#else
    -1,   /* m_size */
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initDLD(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initDLD(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_DLD(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_DLD(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_DLD(PyObject *__pyx_pyinit_module)
#endif
#endif
{
    PyObject *__pyx_t_1 = NULL;
        ...
        if (__pyx_m)
    {
        if (__pyx_m == __pyx_pyinit_module)
            return 0;
        PyErr_SetString(PyExc_RuntimeError, "Module 'DLD' has already been imported. Re-initialisation is not supported.");
        return -1;
    }
#elif PY_MAJOR_VERSION >= 3
...
#endif
    __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_DLD(void)", 0);
...
/*--- Module creation code ---*/
...
#else
#if PY_MAJOR_VERSION < 3
    __pyx_m = Py_InitModule4("DLD", __pyx_methods, __pyx_k_Copyright_2022_Sushant_Kumar_su, 0, PYTHON_API_VERSION);
    Py_XINCREF(__pyx_m);
#else
...
#if PY_MAJOR_VERSION >= 3
    {
        ...
        if (unlikely(!modules))
            __PYX_ERR(0, 1, __pyx_L1_error)
        if (!PyDict_GetItemString(modules, "DLD"))
        {
            if (unlikely(PyDict_SetItemString(modules, "DLD", __pyx_m) < 0))
                __PYX_ERR(0, 1, __pyx_L1_error)
        }
    }
#endif
...
/*--- Execution code ---*/
    ...
    if (unlikely(!__pyx_t_1))
        __PYX_ERR(0, 1, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    if (PyDict_SetItem(__pyx_t_1, __pyx_kp_u_damerau_levenshtein_distance_lin, __pyx_kp_u_Return_the_edit_distance_This_i) < 0)
        __PYX_ERR(0, 1, __pyx_L1_error)
...
__pyx_L1_error:;
    ...
    if (__pyx_m)
    {
        if (__pyx_d)
        {
            __Pyx_AddTraceback("init DLD", __pyx_clineno, __pyx_lineno, __pyx_filename);
        }
        Py_CLEAR(__pyx_m);
    }
    else if (!PyErr_Occurred())
    {
        PyErr_SetString(PyExc_ImportError, "init DLD");
    }
__pyx_L0:;
    __Pyx_RefNannyFinishContext();
#if CYTHON_PEP489_MULTI_PHASE_INIT
...
#pragma GCC diagnostic pop
        ...
        if (likely(PyLong_Check(x)))
    {
        if (is_unsigned)
        {
            ...
            case 1:
                __PYX_VERIFY_RETURN_INT(unsigned long, digit, digits[0])
            case 2:
        ...
        else
        {
            ...
            case 0:
                return (unsigned long)0;
            case -1:
                __PYX_VERIFY_RETURN_INT(unsigned long, sdigit, (sdigit)(-(sdigit)digits[0]))
            case 1:
                __PYX_VERIFY_RETURN_INT(unsigned long, digit, +digits[0])
            case -2:
